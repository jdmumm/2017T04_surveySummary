...
Pollock, tomcod and especially sablefish were all more abundant in this year's survey than in any previous year (Figure 7).  Sablefish CPUE this year was more than two times greater than any other year. Despite field impressions, tomcod CPUE was only slightly greater than in 2008.
...
kable( format = "latex", booktabs = T, align = 'r',
    caption="Number of Tanner crab by 2017 recruit caught in the 2017 Southern District trawl survey.") %>%
kable_styling() %>%
