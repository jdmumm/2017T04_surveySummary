...
##Plot LM ---- 
  ...
  # BASE GRPAHICS USED IN CRUISE SUMMARY -----
  ...
  # ggplot version - (emailed to wyatt for fds?)
    dat %>% filter (PROJECT_CODE == "T04") %>%
    ...
    L17 %>% ggsave(file = './figs/T04LM_2017SCs_gg.png', dpi=300, height=8.5, width=6.5, units="in" )  
